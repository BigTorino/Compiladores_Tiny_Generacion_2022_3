...
public class TablaSimbolos {
	...
	public void cargarTabla(NodoBase raiz) {
		while (raiz != null) {
			...
			if (raiz instanceof NodoDeclaracion) {
				InsertarSimbolo(((NodoDeclaracion) raiz).getIdentificador(), ((NodoDeclaracion) raiz).getTamano(), -1);
			}
	...
	public boolean InsertarSimbolo(String identificador, int tamano, int numLinea) {
		RegistroSimbolo simbolo;
		if (tabla.containsKey(identificador)) {
			return false;
		} else {
